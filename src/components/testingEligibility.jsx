...
const test=()=>{
    return(
        <div id="content" className="p-4 p-md-5 pt-5">
				<h3 className="mb-4" style={{color: '#6E7AFA', textAlign: 'center'}}>Testing Eligibility</h3>
				<p style={{fontWeight: 'bold',color: 'black'}}>Submit the form below to check if you are eligible for COVID-19 testing: </p>
				<form id = "testingEligibilityForm">
					...
					<label className="container">Have you travelled abroad recently?
						<input type="checkbox" />
				...
				<form id = "testingEligibilityForm">
					...
					<input type="number" id="temp" name="temp" className="formFields" style={{width: '180px'}} placeholder="Temperature in &#8457" /><br/>
